...
public class HashTableExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(hashtable2.get("User 1"));
		System.out.println(hashtable2.get("User 2"));
		System.out.println(hashtable2.get("User 3"));
		System.out.println(hashtable2.get("User 4"));
